...
public final class UserView1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            </div>\n");
      out.write("            <div class=\"col-sm-1\">\n");
      out.write("                <input type=\"button\" value=\"Search\" onclick=\"search();\"class=\"btn btn-info\">\n");
      out.write("            </div>\n");
      out.write("            <br>\n");
      out.write("            <br>\n");
      out.write("            <br>\n");
      ...
      out.write("                var email = document.getElementById(\"uemail\").value;\n");
      out.write("                var mobile = document.getElementById(\"umobile\").value;\n");
      out.write("                var country = document.getElementById(\"ucountry\").value;\n");
      out.write("\n");
      out.write("                var user = {\"name\": name, \"email\": email, \"mobile\": mobile, \"country\": country};\n");
      out.write("                var str = JSON.stringify(user);\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("//                            document.getElementById(\"mess\").innerHTML = \"No such User!!!\";\n");
      out.write("//                        } else {\n");
      out.write("//\n");
      out.write("//                            document.getElementById(\"mess\").innerHTML = \"\";\n");
      out.write("//\n");
      out.write("                            var str = request.responseText;\n");
      out.write("                            var arr = JSON.parse(str);\n");
      out.write("                            document.getElementById(\"tbody3\").innerHTML = \"\";\n");
      out.write("\n");
      out.write("                            for(var i=0;i<arr.length;i++){\n");
      out.write("                                \n");
      out.write("                                var ob = arr[i];\n");
      out.write("                                \n");
      out.write("                                window.alert(ob.id);\n");
      out.write("                                window.alert(arr[i].name);\n");
      out.write("                                window.alert(arr[i].email);\n");
      out.write("                                window.alert(arr[i].password);\n");
      out.write("                                window.alert(arr[i].mobile);\n");
      out.write("                                window.alert(arr[i].country);\n");
      out.write("                                window.alert(arr[i].type);\n");
      out.write("                                \n");
      out.write("                            }\n");
      out.write("//                            for (variable in obj) {\n");
      out.write("//\n");
      out.write("//                                var tr = document.createElement(\"tr\");\n");
      out.write("//\n");
      out.write("//                                for (i = 0; i < obj[variable].length; i++) {\n");
      out.write("//                                    var td = document.createElement(\"td\");\n");
      out.write("//                                    td.innerHTML = obj[variable][i];\n");
      out.write("//                                    tr.appendChild(td);\n");
      out.write("//                                    document.getElementById(\"tbody3\").appendChild(tr);\n");
      out.write("//                                }\n");
      out.write("//                            }\n");
      out.write("//                        }\n");
      out.write("                    }\n");
      out.write("                };\n");
      out.write("\n");
      out.write("                request.open(\"GET\", \"UserView1?str=\" + str, true);\n");
